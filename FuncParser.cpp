...
/* 
 *creates a map of <string, vector<string>> where the key is a name of some function and the value is
 * the vector of commands inside the scope that defines the function.
 */
